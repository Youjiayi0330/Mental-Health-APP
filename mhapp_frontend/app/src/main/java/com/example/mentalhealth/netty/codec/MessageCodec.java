package com.example.mentalhealth.netty.codec;

import android.util.Log;
import android.view.WindowManager;

import com.example.mentalhealth.netty.message.MessageType;
import com.example.mentalhealth.netty.message.MyMessage;
...
//        MyMessage myMessage = gson.fromJson(json, MessageType.getMessageClass(messageType));
        ...
        Log.d("decode: ", new String(magicNum)+","+version+","+messageType+","+sequenceId+","+len+","+myMessage);
        list.add(myMessage);
    }
}
